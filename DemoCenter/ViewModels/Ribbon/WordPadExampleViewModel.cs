...
public partial class WordPadExampleViewModel : PageViewModelBase
{
    ...
    private ReactiveCommand<Unit, Unit> mOpenFileCommand;
    public ReactiveCommand<Unit, Unit> CutCmnd
    {
        get
        {
            mOpenFileCommand ??= ReactiveCommand.Create(OpenFileAsync);
            return mOpenFileCommand;
        }
    }
